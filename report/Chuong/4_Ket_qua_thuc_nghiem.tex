...
\textbf{Biểu đồ trạng thái đơn hàng.} Để quản lý vòng đời đơn hàng phức tạp từ lúc tạo, giữ kho tạm thời cho đến khi hoàn thành thanh toán, đóng gói, vận chuyển hoặc tự động hủy do quá hạn, hệ thống sử dụng biểu đồ trạng thái đơn hàng như mô tả ở Hình \ref{fig:order_state_machine}. Biểu đồ này chỉ rõ sự dịch chuyển trạng thái giữa các giai đoạn dựa trên các sự kiện nghiệp vụ và tác vụ của các dịch vụ.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.92\textwidth,height=0.65\textheight,keepaspectratio]{images/generated/order_state_machine.png}
    \caption{Biểu đồ trạng thái vòng đời Đơn hàng}
    \label{fig:order_state_machine}
\end{figure}
...
Mô hình triển khai vật lý tổng thể của hệ thống được minh họa cụ thể trong Hình \ref{fig:physical_deployment}, chỉ rõ cách các thiết bị của Khách hàng và Đối tác kết nối qua các dịch vụ đám mây Cloudflare và Stripe/VNPay để tương tác với máy chủ sản xuất chạy Docker và các cơ sở dữ liệu.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth,height=0.7\textheight,keepaspectratio]{images/generated/physical_deployment.png}
    \caption{Mô hình triển khai vật lý của hệ thống}
