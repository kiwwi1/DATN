...
\textbf{Bảng điều khiển nhà bán hàng.} Vendor quản lý sản phẩm, theo dõi trạng thái đơn hàng và xác nhận giao hàng qua giao diện riêng biệt. Thông báo đơn hàng mới được đẩy tức thì qua kênh SSE, trong khi luồng chat buyer-vendor sử dụng Socket.IO để trao đổi hai chiều theo thời gian thực (Hình \ref{fig:ss_vendor}).
...
Kết quả: 11/11 trường hợp kiểm thử của module \texttt{VoucherService} đạt. Ngoài bộ kiểm thử này, dự án còn duy trì thêm bộ kiểm thử cho \texttt{interactionService} nhằm kiểm tra logic ghi nhận tương tác và gợi ý sản phẩm.
...
\section*{Kết chương}
Chương 4 đã hiện thực hóa các định hướng công nghệ của Chương 3 thành một cấu trúc hệ thống cụ thể gồm kiến trúc nhiều tầng, các mô-đun nghiệp vụ tách lớp, mô hình dữ liệu cho marketplace đa nhà bán hàng, ứng dụng giao diện và backend tích hợp thanh toán, realtime và khuyến nghị. Chương cũng đã tổng hợp công cụ sử dụng, thống kê quy mô mã nguồn, kết quả 11/11 ca kiểm thử đơn vị của \texttt{VoucherService} cùng bốn kịch bản kiểm thử thủ công đầu cuối, đồng thời mô tả rõ cách thức triển khai trong môi trường local và Docker. Những kết quả này là cơ sở trực tiếp để chuyển sang Chương 5, nơi các giải pháp và đóng góp nổi bật sẽ được phân tích dưới góc nhìn kỹ thuật và giá trị thực tiễn.
