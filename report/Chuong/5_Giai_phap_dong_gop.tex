...
Chương 5 đã trình bày các giải pháp kỹ thuật và đóng góp nổi bật của đồ án đối với bài toán xây dựng sàn thương mại điện tử đa nhà bán hàng. Ba nhóm giải pháp chính gồm cơ chế giữ kho nguyên tử kết hợp khóa chống trùng lặp giao dịch, hệ thống khuyến nghị sản phẩm lai có suy hao thời gian và kiến trúc điều phối thanh toán kèm bộ tính toán voucher phân tầng đều hướng đến mục tiêu nâng cao tính nhất quán dữ liệu, mức độ cá nhân hóa và độ an toàn của luồng giao dịch. Các kết quả đạt được trong chương này cho thấy hệ thống không chỉ đáp ứng yêu cầu chức năng cơ bản mà còn xử lý được nhiều tình huống đặc thù của mô hình marketplace, tạo cơ sở để tổng kết mức độ hoàn thành, các hạn chế còn tồn tại và định hướng phát triển ở Chương 6.
